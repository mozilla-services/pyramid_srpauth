...
Helper function for parsing the Authorization header.

This has been split out into a separate file so it's easy to share between
several policy implementations.  It's just one function, not realy worth
turning into a separate module...
...
def parse_authz_header(request):
